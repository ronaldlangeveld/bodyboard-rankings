                ...
                <section className="hero">
                    <div className="hero-body is-transparent">
                        ...
                        <Link to='/' className="title has-text-light is-size-7 button is-outlined is-inverted is-dark customBtnHome">Back home</Link>
                            ...
                            <h1 className="title is-1 has-text-white has-text-centered">World Bodyboarding Women's Rankings</h1>
                                    ...
                                    <table className="table is-fullwidth">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td className="has-text-white">On Tour Since</td>
                                                <td className="has-text-white">Points</td>
                                                <td className="has-text-white">Career Earnings</td>
                                        ...
                                        <tbody>
                                            ...
                                            {lRanks.map(rider => (
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span className="is-size-6">{rider.node.since}</span></td>
                                                    <td><span className="is-size-6"><NumericLabel>{rider.node.total_points}</NumericLabel></span></td>
                                                    <td><span className="is-size-6"><NumericLabel params={currency}>{rider.node.career_earnings}</NumericLabel></span></td>
                                                </tr>
